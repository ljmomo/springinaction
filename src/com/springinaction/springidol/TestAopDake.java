...
public class TestAopDake {
   public static void main(String[] args) throws PerformanceException {
	   ApplicationContext ax = new ClassPathXmlApplicationContext("classpath:spring-idol-aop.xml");
...
/*	  
	 ...
	 /*  
	  ...
	  /* Audience audience = (Audience) ax.getBean("audience");
	   audience.applaud();*/
	/*   Volunteer  volunteer = (Volunteer) ax.getBean("volunteer");
	   volunteer.thinkOfSomething("我有一个房子");*/
}
}
